...
recuperar_email = [
    url(r'^recuperar/recuperar_senha/$',
        ...
        {'template_name': 'usuarios/recuperar_senha.html',
         ...
         'post_reset_redirect': 'atendimento.usuarios:recuperar_senha_finalizado',
    ...
    url(r'^recuperar/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$',
        password_reset_confirm,
        {'post_reset_redirect': 'atendimento.usuarios:recuperar_senha_completo',
...
urlpatterns = recuperar_email + login_usuario + [
